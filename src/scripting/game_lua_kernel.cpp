...
/** Add a new event handler
 * Arg 1: (optional) A boolean - whether to delay variable substitution
...
int game_lua_kernel::intf_add_event_wml(lua_State *L)
{
	...
	bool delayed_variable_substitution = lua_isboolean(L, 1) ? luaW_toboolean(L, 1) : cfg["delayed_variable_substitution"].to_bool();
